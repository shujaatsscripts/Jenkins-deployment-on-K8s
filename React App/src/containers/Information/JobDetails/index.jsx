...
const DisplayJobs = () => {
  ...
  return !loading ? (
    true ? (
            ...
            >
              <Col span={16} style={{ display: "flex" }}>
                ...
                >
                  ...
                  <span style={{ fontSize: "13px" }}>
                    Salary &nbsp;&nbsp;&nbsp;&nbsp;
                    <spsn style={{ fontWeight: "bolder" }}>65,000</spsn> /month
                  </span>
                </div>
                <div
                  style={{
                ...
                >
                  ...
                  />
                  &nbsp;&nbsp;
                  <span style={{ fontSize: "13px" }}>Islamabad, PK</span>
                </div>
                <div
                  style={{
                    // border: "1px solid black",
              ...
              >
                <Switch
                  ...
                  style={{ marginTop: "7px", marginRight: "2rem" }}
                />
      ...
      <Box>{/* <Empty history={history} expired={expired} /> */}</Box>
    )
  ) : (
    <Box>
      <FullPageLoader />
